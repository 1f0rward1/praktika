...
public class CoffeeMakerTest {
	...
	public void testMakeCoffeeAddRecipe3() {
		coffeeMaker.addRecipe(recipe3);
		assertEquals(false, coffeeMaker.addRecipe(recipe3));
	}
	...
	/**
	 * When we set a recipe's name to null
	 * Then we get back the default name.
	 */
	@Test
	public void testCreateRecipe16() throws RecipeException {
		Recipe recipe = new Recipe();
		recipe.setName(null);
